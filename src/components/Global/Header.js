						...
						<div className="col-lg-6 top-content-left">
							<ul className="header-info-w3ls">
								<li>
									...
									<i className="far fa-envelope" />{' '}
									<a href="mailto:info@example.com">shankar.krish777gmail.com</a>
								</li>
								<li>
									<i className="fas fa-phone" /> <a href="tel:+02223688199">+0222 3688 199</a>
								</li>
								<li>
									<i className="far fa-clock" /> Mon – Sat : 9:00 AM - 6:00 PM{' '}
								</li>
							</ul>
						</div>
						...
						<div className="col-md-6 logo text-center">
							<h1>
								<a className="navbar-brand" href="index.html">
									<i className="fas fa-leaf" />Husk Traders
								</a>
							</h1>
						</div>
						<div className="col-md-3 login-right-img text-center">
							<a
								className="request text-uppercase"
								href="#"
								data-toggle="modal"
